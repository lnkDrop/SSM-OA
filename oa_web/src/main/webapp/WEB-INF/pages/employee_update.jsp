                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="sn" class="field select">
                                    <form:select path="departmentSn" cssClass="gui-input" items="${dlist}"
                                                 itemLabel="name" itemValue="sn" placeholder="所属部门..."/>
                                    <i class="arrow double"></i>
                                </label>
                            </div>
                            <div class="col-md-6">
                                <label for="post" class="field select">
                                    <form:select path="post" cssClass="gui-input" items="${plist}" placeholder="职务..."/>
                                    <i class="arrow double"></i>
                                </label>
                            </div>
                        </div>
