...
public class Contant {
    ...
    /*报销单状态*/
    public static final String EXPENSE_CREATED = "新创建";
    public static final String EXPENSE_SUBMIT = "已提交";
    public static final String EXPENSE_APPROVED = "已审核";
    public static final String EXPENSE_BACK = "已打回";
    public static final String EXPENSE_TERMINATION = "已终止";
    public static final String EXPENSE_RECHECK = "待复审";
    public static final String EXPENSE_PAID = "已打款";
    /*审核额度*/
